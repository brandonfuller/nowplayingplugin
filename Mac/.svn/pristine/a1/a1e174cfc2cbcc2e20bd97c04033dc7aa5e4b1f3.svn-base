...
OSStatus ConfigureVisual(VisualPluginData* visualPluginData, ConfigurationData* configurationData)
{
	...
	[myWindowController showWindow:myWindowController];
	[[myWindowController window]setDelegate:myWindowController];
	[myWindowController populateFields:configurationData];
